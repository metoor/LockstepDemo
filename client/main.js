...
var GameObject = function (id) {
    ...
    this.updateUi = function (dt, context, key) {
        var dx = this.aimX - this.x
        var dy = this.aimY - this.y
        var step = Math.floor(dt / 100 * 5)
        if(step == 0)
        {
            step = 1
        }
        console.log("x = ", this.x, "  X = ", this.aimX, " dx = ", dx, "  step = ", step, " dt = ", dt)
        ...
        context.fillRect(this.x, this.y, BOX_SIZE, BOX_SIZE)
        context.font = "15px Courier New";
        context.fillStyle = "#FFFFFF";
        context.fillText(key, this.x, this.y + BOX_SIZE, BOX_SIZE);
    }
}
